...
This document provides the REST API reference for the Agent Orchestration System.
...
```json
{
  ...
  "data": {
    "results": [
      { "stepIndex": 0, "output": { "text": "..." }, "durationMs": 1200 },
      { "stepIndex": 1, "output": { "text": "..." }, "durationMs": 1100 }
    ],
...
```json
{
  ...
  "data": {
    "results": [
      { "stepIndex": 0, "output": { "text": "..." }, "durationMs": 1200 },
      { "stepIndex": 1, "output": { "text": "..." }, "durationMs": 1100 },
      { "stepIndex": 2, "output": { "audioUrl": "..." }, "durationMs": 800 }
    ],
...
| `WORKFLOW_INVALID` | 400 | Invalid workflow definition |
| `AGENT_UNAVAILABLE` | 503 | Agent is not available |
| `TEMPLATE_ERROR` | 400 | Template interpolation failed |
| `TIMEOUT_ERROR` | 408 | Operation timed out |
| `RATE_LIMIT_EXCEEDED` | 429 | Too many requests |

## WebSocket Events

Connect to the WebSocket server and emit/listen to these events:
...
- [Agent Workflow Examples](../examples/agent-workflows.md)
